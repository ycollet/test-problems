...
function Res = get_min_bound_binh_1()
Res = [-5;-5]
endfunction

function Res = get_max_bound_binh_1()
Res = [10;10]
endfunction
...
function Res = get_min_bound_fonseca_1()
Res = [-10;-10]
endfunction

function Res = get_max_bound_fonseca_1()
Res = [10;10]
endfunction
...
function Res = get_min_bound_fonseca_2(n)
if ~isdef('n','local') then n = 2; end;
Res = -4*ones(n,1);
endfunction

function Res = get_max_bound_fonseca_2(n)
if ~isdef('n','local') then n = 2; end;
Res = 4*ones(n,1);
endfunction
...
function Res = get_min_bound_kursawe_1(n)
if ~isdef('n','local') then n = 2; end;
Res = -10*ones(n,1);
endfunction

function Res = get_max_bound_kursawe_1(n)
if ~isdef('n','local') then n = 2; end;
Res = 10*ones(n,1);
endfunction
...
function Res = get_min_bound_laumanns_1()
Res = [-50;-50];
endfunction

function Res = get_max_bound_laumanns_1()
Res = [50;50];
endfunction
...
function Res = get_min_bound_lis_1()
Res = [-5;-5];
endfunction

function Res = get_max_bound_lis_1()
Res = [10;10];
endfunction
...
function Res = get_min_bound_murata_1()
Res = [1;1];
endfunction

function Res = get_max_bound_murata_1()
Res = [4;2];
endfunction
...
function Res = get_min_bound_poloni_1()
Res = [-%pi;-%pi];
endfunction

function Res = get_max_bound_poloni_1()
Res = [%pi;%pi];
endfunction
...
function Res = get_min_bound_quagliar_1(n)
if ~isdef('n','local') then n = 2; end;
Res = -5.12 * ones(n,1);
endfunction

function Res = get_max_bound_quagliar_1(n)
if ~isdef('n','local') then n = 2; end;
Res = 5.12*ones(n,1);
endfunction
...
function Res = get_min_bound_rendon_1()
Res = -3 * ones(2,1);
endfunction

function Res = get_max_bound_rendon_1()
Res = 3*ones(2,1);
endfunction
...
function Res = get_min_bound_rendon_2()
Res = -3 * ones(2,1);
endfunction

function Res = get_max_bound_rendon_2()
Res = 3*ones(2,1);
endfunction
...
function Res = get_min_bound_schaffer_1()
Res = -5;
endfunction

function Res = get_max_bound_schaffer_1()
Res = 10;
endfunction
...
function Res = get_min_bound_schaffer_2()
Res = -5;
endfunction

function Res = get_max_bound_schaffer_2()
Res = 10;
endfunction
...
function Res = get_min_bound_binh_2()
Res = 10^(-6)*ones(2,1);
endfunction

function Res = get_max_bound_binh_2()
Res = 10^6*ones(2,1);
endfunction
...
function Res = get_min_bound_viennet_1()
Res = -2*ones(2,1);
endfunction

function Res = get_max_bound_viennet_1()
Res = 2*ones(2,1);
endfunction
...
function Res = get_min_bound_viennet_2()
Res = -4*ones(2,1);
endfunction

function Res = get_max_bound_viennet_2()
Res = 4*ones(2,1);
endfunction
...
function Res = get_min_bound_viennet_3()
Res = -3*ones(2,1);
endfunction

function Res = get_max_bound_viennet_3()
Res = 3*ones(2,1);
endfunction
...
function Res = get_min_bound_belegundu_1()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_belegundu_1()
Res = [5;3];
endfunction
...
function Res = get_min_bound_binh_3()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_binh_3()
Res = [5;3];
endfunction
...
function Res = get_min_bound_jimenez_1()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_jimenez_1()
Res = 100*ones(2,1);
endfunction
...
function Res = get_min_bound_kita_1()
Res = -10*ones(2,1);
endfunction

function Res = get_max_bound_kita_1()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_osyczka_1()
Res = [2;5]
endfunction

function Res = get_max_bound_osyczka_1()
Res = [7;10];
endfunction
...
function Res = get_min_bound_osyczka_2()
Res = [0;0;1;0;1;0]
endfunction

function Res = get_max_bound_osyczka_2()
Res = [10;10;5;6;5;10];
endfunction
...
function Res = get_min_bound_srinivas_1()
Res = [-20;-20]
endfunction

function Res = get_max_bound_srinivas_1()
Res = [20;20];
endfunction
...
function Res = get_min_bound_tanaka_1()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_tanaka_1()
Res = %pi*ones(2,1);
endfunction
...
function Res = get_min_bound_binh_4()
Res = -10*ones(2,1);
endfunction

function Res = get_max_bound_binh_4()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_viennet_4()
Res = -4*ones(2,1);
endfunction

function Res = get_max_bound_viennet_4()
Res = 4*ones(2,1);
endfunction
...
function Res = get_min_bound_coello_1()
Res = [10;10;0.9;0.9];
endfunction

function Res = get_max_bound_coello_1()
Res = [80;50;5;5];
endfunction
...
function Res = get_min_bound_coello_2()
Res = [6.3969;0.6931;3.9120];
endfunction

function Res = get_max_bound_coello_2()
...
function Res = get_min_bound_coello_3()
Res = %eps*ones(4,1);
endfunction

function Res = get_max_bound_coello_3()
Res = 400*ones(4,1);
endfunction
...
function Res = get_min_bound_deb_1(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_1(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_2(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_2(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_3(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_3(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_4(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_4(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_5(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_5(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_6(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_6(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_deb_7(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_7(n)
if ~isdef('n','local') then n = 10; end;
Res = 10*ones(n,1);
Res(1) = 1;
endfunction
...
function Res = get_min_bound_deb_8(n)
if ~isdef('n','local') then n = 10; end;
Res = zeros(n,1);
endfunction

function Res = get_max_bound_deb_8(n)
if ~isdef('n','local') then n = 10; end;
Res = ones(n,1);
endfunction
...
function Res = get_min_bound_veldmop_3()
Res = -%pi*ones(2,1);
endfunction

function Res = get_max_bound_veldmop_3()
Res = %pi*ones(2,1);
endfunction
...
function Res = get_min_bound_veldmop_4()
Res = -5*ones(3,1);
endfunction

function Res = get_max_bound_veldmop_4()
Res = 5*ones(3,1);
endfunction
...
function Res = get_min_bound_veldmop_5()
Res = -30*ones(2,1);
endfunction

function Res = get_max_bound_veldmop_5()
Res = 30*ones(2,1);
endfunction
...
function Res = get_min_bound_veldmop_6()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_veldmop_6()
Res = 1*ones(2,1);
endfunction
...
function Res = get_min_bound_veldmop_7()
Res = -400*ones(2,1);
endfunction

function Res = get_max_bound_veldmop_7()
Res = 400*ones(2,1);
endfunction
...
function Res = get_min_bound_veldmopc_1()
Res = [0;0];
endfunction

function Res = get_max_bound_veldmopc_1()
Res = [5;3];
endfunction
...
function Res = get_min_bound_veldmopc_2()
Res = [0;0;0;1;1;0];
endfunction

function Res = get_max_bound_veldmopc_2()
Res = [10;10;10;5;5;6];
endfunction
...
function Res = get_min_bound_hanne_1()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_hanne_1()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_hanne_2()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_hanne_2()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_hanne_3()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_hanne_3()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_hanne_4()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_hanne_4()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_hanne_5()
Res = 0*ones(2,1);
endfunction

function Res = get_max_bound_hanne_5()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_bound_meca_1()
Res = 0.03;
endfunction

function Res = get_max_bound_meca_1()
Res = 0.1;
endfunction
...
function Res = get_min_bound_meca_2()
Res = 0.03*ones(2,1);
endfunction

function Res = get_max_bound_meca_2()
Res = 0.1*ones(2,1);
endfunction
...
function Res = get_min_bound_trigo_1()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_1()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_2()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_2()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_3()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_3()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_4()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_4()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_4_bis()
Res = [-%pi/6;0];
endfunction

function Res = get_max_bound_trigo_4_bis()
Res = [4*%pi/6;1];
endfunction
...
function Res = get_min_bound_trigo_5()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_5()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_5_bis()
Res = [-%pi/6;0];
endfunction

function Res = get_max_bound_trigo_5_bis()
Res = [4*%pi/6;1];
endfunction
...
function Res = get_min_bound_trigo_6()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_6()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_6_bis()
Res = [-%pi/6;0];
endfunction

function Res = get_max_bound_trigo_6_bis()
Res = [4*%pi/6;1];
endfunction
...
function Res = get_min_bound_trigo_7()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_7()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_8()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_8()
Res = [%pi/2;1];
endfunction
...
function Res = get_min_bound_trigo_9()
Res = [0;0];
endfunction

function Res = get_max_bound_trigo_9()
Res = [%pi/2;1];
endfunction
