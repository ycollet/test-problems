...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_inip(n,x,l,u,m,lambda,rho,equatn,
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalf(n,x,f,flag)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalg(n,x,g,flag)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalh(n,x,hlin,hcol,hval,nnzh,flag)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalc(n,x,ind,c,flag)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evaljac(n,x,ind,indjac,valjac,nnzjac,
     +                                   flag)
...
C     COMMON BLOCKS
      ...
      if ( 1 .le. ind .and. ind .le. nite ) then
          call gbelong(n,x,ind,indjac,valjac,nnzjac)
      else if ( ind .eq. nite + 1 ) then
          call goverlap(n,x,valjac)
          nnzjac = n - 1
          do i = 1,nnzjac
              indjac(i) = i
          end do
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalhc(n,x,ind,hclin,hccol,hcval,nnzhc,
     +                                  flag)
...
C     COMMON BLOCKS
      ...
      if ( 1 .le. ind .and. ind .le. nite ) then
          call hbelong(n,x,ind,hclin,hccol,hcval,nnzhc)
      else if ( ind .eq. nite + 1 ) then
          call hoverlap(n,x,hclin,hccol,hcval,nnzhc)
      end if
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_evalhlp(n,x,m,lambda,p,hp,goth,flag)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_endp(n,x,l,u,m,lambda,rho,equatn,
     +                                linear)
...
C     FUNCTIONS
      ...
      call genpack_cc_mina_drawsol(nite,iterad,n,x,'solution.mp')
      call genpack_cc_mina_savesol(nite,iterad,ndim,n,x,vover,valoc,
     +                             'solution.dat')
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_drawsol(nite,iterad,n,x,solfile)
...
C     ******************************************************************
      ...
      subroutine genpack_cc_mina_savesol(nite,iterad,ndim,n,x,vover,
     +                                   valoc,solfile)
...
C     ******************************************************************
      ...
      subroutine hoverlap(n,x,hlin,hcol,hval,nnzh)
...
C     COMPUTE SPARSE OVERLAPPING SECOND DERIVATIVES
      ...
      do k = 1,nbr
        ...
        l = start(i,j)
 10     if ( l .ne. 0 ) then
         call hnrdist(n,x,hlin,hcol,hval,nnzh,l,next(l)) 
         call hnrdist(n,x,hlin,hcol,hval,nnzh,l,start(i-1,j+1))
         call hnrdist(n,x,hlin,hcol,hval,nnzh,l,start(i,  j+1))  
         call hnrdist(n,x,hlin,hcol,hval,nnzh,l,start(i+1,j+1))  
         call hnrdist(n,x,hlin,hcol,hval,nnzh,l,start(i+1,j  ))
         l = next(l)
         go to 10
        end if
      end do
...
C     ******************************************************************
      ...
      subroutine hnrdist(n,x,hlin,hcol,hval,nnzh,i,lstart)
...
C     ******************************************************************
      ...
      subroutine hbelong(n,x,ind,hlin,hcol,hval,nnzh)
