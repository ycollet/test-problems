...
C     ******************************************************************
      ...
      subroutine mountain1_inip(n,x,l,u,m,lambda,rho,equatn,linear,
...
C     LOCAL SCALARS
      integer b,i,j
      double precision dist,drand,mountain1_fmoun,seed,tmp
...
C     Initial point
      x(n) = max( mountain1_fmoun(pi(1),pi(2)), 
     +            mountain1_fmoun(pf(1),pf(2)) )
      do i = 1,np
          b = 2 * ( i - 1 )
          do j = 1,2
          ...
          x(n) = max( x(n), mountain1_fmoun(x(b+1),x(b+2)) )
      end do
...
C     ******************************************************************
      ...
      subroutine mountain1_evalf(n,x,f,flag)
...
C     ******************************************************************
      ...
      subroutine mountain1_evalg(n,x,g,flag)
...
C     ******************************************************************
      ...
      subroutine mountain1_evalh(n,x,hlin,hcol,hval,nnzh,flag)
...
C     ******************************************************************
      ...
      subroutine mountain1_evalc(n,x,ind,c,flag)
...
C     LOCAL SCALARS
      integer b,b1,b2
      double precision mountain1_fmoun
...
C     COMMON BLOCKS
      ...
      if ( ind .eq. 1 ) then
          ...
          b = 2 * ( ind - np - 2 )
          c = mountain1_fmoun(x(b+1),x(b+2)) - x(n)
...
C     ******************************************************************
      ...
      subroutine mountain1_evaljac(n,x,ind,indjac,valjac,nnzjac,flag)
...
C     COMMON BLOCKS
      ...
      if ( ind .eq. 1 ) then
          ...
          call mountain1_gmoun(x(b+1),x(b+2),valjac(1),valjac(2))
...
C     ******************************************************************
      ...
      subroutine mountain1_evalhc(n,x,ind,hclin,hccol,hcval,nnzhc,flag)
...
C     COMMON BLOCKS
      ...
      if ( ind .eq. 1 ) then
          ...
          call mountain1_hmoun(x(b+1),x(b+2),hcval(1),hcval(2),hcval(3))
...
C     ******************************************************************
      ...
      subroutine mountain1_evalhlp(n,x,m,lambda,p,hp,goth,flag)
...
C     ******************************************************************
      ...
      subroutine mountain1_endp(n,x,l,u,m,lambda,rho,equatn,linear)
...
C     LOCAL SCALARS
      integer b,i,imax
      double precision f,fmax,mountain1_fmoun
...
C     COMMON BLOCKS
      ...
      call mountain1_gmoun(x(b+1),x(b+2),g(1),g(2))
      write(*,*) 'Gradient of the energy: ',g(1),g(2)

      call mountain1_hmoun(x(b+1),x(b+2),h(1,1),h(2,2),h(1,2))
...
C     ******************************************************************
      ...
      double precision function mountain1_fmoun(x,y)
...
C     SCALAR ARGUMENTS
      ...
      mountain1_fmoun = sin( x * y ) + sin( x + y )
...
C     ******************************************************************
      ...
      subroutine mountain1_gmoun(x,y,dfdx,dfdy)
...
C     ******************************************************************
      ...
      subroutine mountain1_hmoun(x,y,dfdxx,dfdyy,dfdxy)
