...
C     ******************************************************************
      ...
      subroutine packccmn_feas_inip(n,x,l,u,m,lambda,rho,equatn,linear,
     &                              nd_in,nite_in,iterad_in,objrad_in,
     &                              seed_in)
...
C     COMMON SCALARS
      integer nite,ndim,nd_in,nite_in
      double precision iterad,objrad,iterad_in,objrad_in
...
C     LOCAL SCALARS
      integer i,j,k
      double precision drand,seed,r,t,seed_in
...
C     Radii of circular items and object, respectively
      iterad = iterad_in
      objrad = objrad_in
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalf(n,x,f,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalg(n,x,g,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalh(n,x,hlin,hcol,hval,hnnz,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalc(n,x,ind,c,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evaljac(n,x,ind,jcvar,jcval,jcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalhc(n,x,ind,hclin,hccol,hcval,
     +                                hcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_evalhlp(n,x,m,lambda,p,hp,goth,flag)
...
C     ******************************************************************
      ...
      subroutine packccmn_feas_endp(n,x,l,u,m,lambda,rho,equatn,linear)
