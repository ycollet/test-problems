...
C     ******************************************************************
      ...
      subroutine location_inip(n,x,l,u,m,lambda,rho,equatn,linear)
...
C     COMMON ARRAYS
     ...
     +        pol(nvsmax),radii(ncmax),vert(2*nvsmax)

C     LOCAL SCALARS
      integer i,inform,nvmapp,nvmipp,nx,ny,pnum
      double precision procit,propol,rmax,rmin,secmar,step,xstep,ystep

C     EXTERNAL SUBROUTINES
      external location_genpro
...
C     GENERATE THE PROBLEM
      ...
      call location_genpro(nx,ny,xstep,ystep,procit,propol,nvmipp,
     +                     nvmapp,rmin,rmax,inform)
...
C     ******************************************************************
      ...
      subroutine location_evalf(n,x,f,flag)
...
C     ******************************************************************
      ...
      subroutine location_evalg(n,x,g,flag)
...
C     ******************************************************************
      ...
      subroutine location_evalh(n,x,hlin,hcol,hval,hnnz,flag)
...
C     ******************************************************************
      ...
      subroutine location_evalc(n,x,ind,c,flag)
...
C     ******************************************************************
      ...
      subroutine location_evaljac(n,x,ind,jcvar,jcval,jcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine location_evalhc(n,x,ind,hclin,hccol,hcval,hcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine location_evalhlp(n,x,m,lambda,p,hp,goth,flag)
...
C     ******************************************************************
      ...
      subroutine location_endp(n,x,l,u,m,lambda,rho,equatn,linear)
...
C     *****************************************************************
      ...
      subroutine location_genpro(nx,ny,xstep,ystep,procit,propol,
     +                           nvmipp,nvmapp,rmin,rmax,inform)
...
C     COMPLETELY INSIDE THE CASSINIAN CURVE
          ...
          do j = 0,ny - 1
              ...
              if ( drand(seed) .le. propol ) then
                ...
                ! GENERATE A CITY-POLYGON
                  ...
                  call location_genpol(cx,cy,nvmipp,nvmapp,rmin,rmax,
     +                                 seed,inform)
     ...
     +                 ( outcre .and. drand(seed) .le. procit ) ) ) then
                ...
                ! GENERATE A CITY-CIRCLE
                  ...
                  call location_gencir(cx,cy,rmin,rmax,seed,inform)
...
C     *****************************************************************
      ...
      subroutine location_gencir(cx,cy,rmin,rmax,seed,inform)
...
C     *****************************************************************
      ...
      subroutine location_genpol(cx,cy,nvmipp,nvmapp,rmin,rmax,
     +                           seed,inform)
...
C     COMMON ARRAYS
      integer nvs(npmax)
      double precision edges(3*nvsmax),pcent(2*npmax),pol(nvsmax),
     +        vert(2*nvsmax)
...
C     EXTERNAL SUBROUTINES
      external location_class,location_constr
...
C     CLASSIFY THE ANGLES IN DECREASING ORDER
      ...
      call location_class(nvs(np + 1),angl)
...
C     CONSTRUCT THE EDGES
      ...
      do i = totnvs + 1,totnvs + nvs(np+1) - 2
          call location_constr(vert(2*i-1),vert(2*i),vert(2*i+1),
     +                vert(2*i+2),vert(2*i+3),vert(2*i+4),edges(3*i-2),
     +                edges(3*i-1),edges(3*i),inform)
      ...
      call location_constr(vert(2*i-1),vert(2*i),vert(2*i+1),
     +            vert(2*i+2),vert(2*totnvs+1),vert(2*totnvs+2),
     +            edges(3*i-2),edges(3*i-1),edges(3*i),inform)
      ...
      call location_constr(vert(2*i-1),vert(2*i),vert(2*totnvs+1),
...
C     *****************************************************************
      ...
      subroutine location_constr(x1,y1,x2,y2,x3,y3,a,b,c,inform)
