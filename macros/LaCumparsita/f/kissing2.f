...
C     ******************************************************************
      ...
      subroutine kissing2_inip(n,x,l,u,m,lambda,rho,equatn,linear,
     &                         nd_in,np_in,seed_in)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalf(n,x,f,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalg(n,x,g,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalh(n,x,hlin,hcol,hval,hnnz,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalc(n,x,ind,c,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evaljac(n,x,ind,jcvar,jcval,jcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalhc(n,x,ind,hclin,hccol,hcval,hcnnz,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_evalhlp(n,x,m,lambda,p,hp,goth,flag)
...
C     ******************************************************************
      ...
      subroutine kissing2_endp(n,x,l,u,m,lambda,rho,equatn,linear)
