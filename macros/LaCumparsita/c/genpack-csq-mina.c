/* genpack-csq-mina.f -- translated by f2c (version 20000817).
...
/*     items), the objective is to find the smallest square (called */
/*     object) that fits the  items without overlapping. The model */
/*     follows: */

/*     Mininimize L */
/*     subject to ci in [r,L-r] x [r,L-r], for all i */
/*                sum_{i < j} max{ 0, (2r)^2 - d(ci,cj)^2 }^2 = 0 */

/*     (The variables are the centers ci in R^2 of the circular items */
/*     and the side L of the squared object that fits the items.) */
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_inip__(n, x, l, u, m, lambda, rho, 
...
l\002,/,\002 circles into a squared region, minimizing the size\002,\002 of \
the region.\002,/)";
    ...
    extern integer genpack_csq_mina_ceil__();
    static doublereal objsizeub;
    static integer ind;
...
/* Computing 2nd power */
    ...
    objsizeub = sqrt(d__1 * d__1 * 6.2831853999999998 * packdata_1.nite);
    d__1 = objsizeub / packdata_1.iterad;
    partdata_1.nreg = genpack_csq_mina_ceil__(&d__1);
    partdata_1.nreg = min(partdata_1.nreg,10000);
...
/* Computing 2nd power */
    d__1 = packdata_1.iterad;
    x[*n] = sqrt(d__1 * d__1 * 3.1415927 * packdata_1.nite * (drand_(&seed) + 
	    1.));
    i__ = 1;
	...
	for (j = 1; j <= i__2; ++j) {
	    ...
	    x[ind] = packdata_1.iterad + drand_(&seed) * (x[*n] - 
		    packdata_1.iterad * 2.);
	}
    }
/*     Lower and upper bounds */
    i__1 = *n;
    for (i__ = 1; i__ <= i__1; ++i__) {
	l[i__] = packdata_1.iterad;
	u[i__] = 1e20;
    }
    l[*n] = packdata_1.iterad * 2.;
/*     Number of constraints (equalities plus inequalities) */
    *m = packdata_1.ndim * packdata_1.nite + 1;
...
/*     constraint, otherwise set linear(i) = .false. */
    ...
    linear[*m] = FALSE_;
    return 0;
} /* genpack_csq_mina_inip__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalf__(n, x, f, flag__)
integer *n;
doublereal *x, *f;
integer *flag__;
{
...
/*     ARRAY ARGUMENTS */
    ...
    *flag__ = 0;
    *f = x[*n];
} /* genpack_csq_mina_evalf__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalg__(n, x, g, flag__)
integer *n;
doublereal *x, *g;
integer *flag__;
{
...
/*     LOCAL SCALARS */
    ...
    *flag__ = 0;
    ...
    g[*n] = 1.;
} /* genpack_csq_mina_evalg__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalh__(n, x, hlin, hcol, hval, nnzh, 
	flag__)
integer *n;
doublereal *x;
integer *hlin, *hcol;
...
/*     ARRAY ARGUMENTS */
    ...
    *flag__ = 0;
    *nnzh = 0;
} /* genpack_csq_mina_evalh__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalc__(n, x, ind, c__, flag__)
integer *n;
doublereal *x;
integer *ind;
doublereal *c__;
...
{
    static integer m;
    extern doublereal genpack_csq_mina_overlap__(), genpack_csq_mina_belong__(
	    );
...
/*     EXTERNAL FUNCTIONS */
    ...
    *flag__ = 0;
    m = packdata_1.ndim * packdata_1.nite + 1;
    if (1 <= *ind && *ind <= m - 1) {
	*c__ = genpack_csq_mina_belong__(n, &x[1], ind);
    } else if (*ind == m) {
	*c__ = genpack_csq_mina_overlap__(n, &x[1]);
    }
} /* genpack_csq_mina_evalc__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evaljac__(n, x, ind, indjac, valjac, 
	nnzjac, flag__)
integer *n;
doublereal *x;
integer *ind, *indjac;
...
integer *nnzjac, *flag__;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int genpack_csq_mina_gbelong__();
    static integer i__, m;
    extern /* Subroutine */ int genpack_csq_mina_goverlap__();
...
/*     COMMON BLOCKS */
    ...
    *flag__ = 0;
    m = packdata_1.ndim * packdata_1.nite + 1;
    if (1 <= *ind && *ind <= m - 1) {
	genpack_csq_mina_gbelong__(n, &x[1], ind, &indjac[1], &valjac[1], 
		nnzjac);
    } else if (*ind == m) {
	genpack_csq_mina_goverlap__(n, &x[1], &valjac[1]);
	*nnzjac = *n - 1;
	i__1 = *nnzjac;
	for (i__ = 1; i__ <= i__1; ++i__) {
	    indjac[i__] = i__;
...
} /* genpack_csq_mina_evaljac__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalhc__(n, x, ind, hclin, hccol, hcval,
	 nnzhc, flag__)
integer *n;
doublereal *x;
...
{
    extern /* Subroutine */ int genpack_csq_mina_hbelong__();
    static integer m;
    extern /* Subroutine */ int genpack_csq_mina_hoverlap__();
...
/*     COMMON BLOCKS */
    ...
    *flag__ = 0;
    m = packdata_1.ndim * packdata_1.nite + 1;
    if (1 <= *ind && *ind <= m - 1) {
	genpack_csq_mina_hbelong__(n, &x[1], ind, &hclin[1], &hccol[1], &
		hcval[1], nnzhc);
    } else if (*ind == m) {
	genpack_csq_mina_hoverlap__(n, &x[1], &hclin[1], &hccol[1], &hcval[1],
		 nnzhc);
    }
} /* genpack_csq_mina_evalhc__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_evalhlp__(n, x, m, lambda, p, hp, goth, 
	flag__)
integer *n;
doublereal *x;
integer *m;
...
/*     ****************************************************************** */
    ...
    /* Function Body */
    *flag__ = -1;
} /* genpack_csq_mina_evalhlp__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_endp__(n, x, l, u, m, lambda, rho, 
	equatn, linear)
integer *n;
doublereal *x, *l, *u;
integer *m;
...
{
    /* Format strings */
    static char fmt_1[] = "(/,\002 Side                          = \002,f12.\
...
cation violation  = \002,3x,1p,d9.1)";
    ...
    /* Local variables */
    extern doublereal genpack_csq_mina_maxaloc__();
    extern /* Subroutine */ int genpack_csq_mina_drawsol__(), 
	    genpack_csq_mina_savesol__();
    extern doublereal genpack_csq_mina_maxover__();
    static doublereal valoc, vover;

    /* Fortran I/O blocks */
    static cilist io___14 = { 0, 6, 0, fmt_1, 0 };
...
/*     FUNCTIONS */
    ...
    /* Function Body */
    vover = genpack_csq_mina_maxover__(n, &x[1]);
    valoc = genpack_csq_mina_maxaloc__(n, &x[1]);
    s_wsfe(&io___14);
    ...
    e_wsfe();
/*     genpack_csq_mina_drawsol__(&packdata_1.nite, &packdata_1.iterad, n, &x[1], */
/* 	     "solution.mp", (ftnlen)11); */
/*     genpack_csq_mina_savesol__(&packdata_1.nite, &packdata_1.iterad, & */
/* 	    packdata_1.ndim, n, &x[1], &vover, &valoc, "solution.dat", ( */
/* 	    ftnlen)12); */
} /* genpack_csq_mina_endp__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_maxover__(n, x)
integer *n;
doublereal *x;
{
    /* System generated locals */
    ...
    extern doublereal genpack_csq_mina_mnrover__();
    extern /* Subroutine */ int genpack_csq_mina_classify__();
...
/*     COMMON BLOCKS */
    ...
    /* Function Body */
    genpack_csq_mina_classify__(n, &x[1]);
    ret_val = 0.;
    i__1 = partdata_1.nbr;
    for (k = 1; k <= i__1; ++k) {
...
L10:
	if (l != 0) {
/* Computing MAX */
	    d__1 = ret_val, d__2 = genpack_csq_mina_mnrover__(n, &x[1], &l, &
		    partdata_1.next[l - 1]);
...
/* Computing MAX */
    ...
    return ret_val;
} /* genpack_csq_mina_maxover__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_mnrover__(n, x, i__, lstart)
integer *n;
doublereal *x;
integer *i__, *lstart;
{
...
/* Computing MAX */
    ...
    return ret_val;
} /* genpack_csq_mina_mnrover__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_maxaloc__(n, x)
integer *n;
doublereal *x;
{
    /* System generated locals */
...
/*     COMMON BLOCKS */
	...
	i__2 = packdata_1.ndim;
	for (k = 1; k <= i__2; ++k) {
	    ind = (i__ - 1) * packdata_1.ndim + k;
/* Computing MAX */
	    d__1 = ret_val, d__2 = packdata_1.iterad - x[ind];
	    ret_val = max(d__1,d__2);
/* Computing MAX */
	    d__1 = ret_val, d__2 = x[ind] - x[*n] + packdata_1.iterad;
	    ret_val = max(d__1,d__2);
	}
    }
    return ret_val;
} /* genpack_csq_mina_maxaloc__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_drawsol__(nite, iterad, n, x, solfile, 
	solfile_len)
integer *nite;
doublereal *iterad;
integer *n;
...
cm;\002)";
    static char fmt_40[] = "(\002draw (0,0)--(0,\002,f20.10,\002u)--(\002,f2\
0.10,\002u,\002,f20.10,\002u)\002,\002--(\002,f20.10,\002u,0)--cycle;\002,/)";
...
hifted (\002,f20.10,\002u,\002,f20.10,\002u);\002)";
    ...
    /* Fortran I/O blocks */
    static cilist io___28 = { 0, 10, 0, fmt_10, 0 };
    static cilist io___29 = { 0, 10, 0, fmt_40, 0 };
    static cilist io___31 = { 0, 10, 0, fmt_20, 0 };
    static cilist io___32 = { 0, 10, 0, fmt_30, 0 };
...
} /* genpack_csq_mina_drawsol__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_savesol__(nite, iterad, ndim, n, x, 
...
{
    /* Format strings */
    static char fmt_10[] = "(/,\002Size of the squared object    = \002,f16.\
...
ion:\002,/)";
    ...
    /* Fortran I/O blocks */
    static cilist io___33 = { 0, 10, 0, fmt_10, 0 };
    static cilist io___35 = { 0, 10, 0, fmt_20, 0 };
...
/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_overlap__(n, x)
integer *n;
doublereal *x;
{
    /* System generated locals */
...
L10:
    ...
    return ret_val;
} /* genpack_csq_mina_overlap__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_goverlap__(n, x, g)
integer *n;
doublereal *x, *g;
{
    /* System generated locals */
    ...
    /* Local variables */
    static integer i__, j, k, l;
    extern /* Subroutine */ int genpack_csq_mina_gnrdist__(), 
	    genpack_csq_mina_classify__();
...
L10:
	if (l != 0) {
	    genpack_csq_mina_gnrdist__(n, &x[1], &g[1], &l, &partdata_1.next[
		    l - 1]);
	    genpack_csq_mina_gnrdist__(n, &x[1], &g[1], &l, &partdata_1.start[
		    i__ - 1 + (j + 1) * 10002]);
	    genpack_csq_mina_gnrdist__(n, &x[1], &g[1], &l, &partdata_1.start[
		    i__ + (j + 1) * 10002]);
	    genpack_csq_mina_gnrdist__(n, &x[1], &g[1], &l, &partdata_1.start[
...
} /* genpack_csq_mina_goverlap__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_hoverlap__(n, x, hlin, hcol, hval, nnzh)
integer *n;
doublereal *x;
integer *hlin, *hcol;
doublereal *hval;
integer *nnzh;
{
    ...
    /* Local variables */
    static integer i__, j, k, l;
    extern /* Subroutine */ int genpack_csq_mina_hnrdist__(), 
	    genpack_csq_mina_classify__();
...
L10:
	if (l != 0) {
	    genpack_csq_mina_hnrdist__(n, &x[1], &hlin[1], &hcol[1], &hval[1],
		     nnzh, &l, &partdata_1.next[l - 1]);
	    genpack_csq_mina_hnrdist__(n, &x[1], &hlin[1], &hcol[1], &hval[1],
		     nnzh, &l, &partdata_1.start[i__ - 1 + (j + 1) * 10002]);
	    genpack_csq_mina_hnrdist__(n, &x[1], &hlin[1], &hcol[1], &hval[1],
		     nnzh, &l, &partdata_1.start[i__ + (j + 1) * 10002]);
	    genpack_csq_mina_hnrdist__(n, &x[1], &hlin[1], &hcol[1], &hval[1],
		     nnzh, &l, &partdata_1.start[i__ + 1 + (j + 1) * 10002]);
	    genpack_csq_mina_hnrdist__(n, &x[1], &hlin[1], &hcol[1], &hval[1],
		     nnzh, &l, &partdata_1.start[i__ + 1 + j * 10002]);
	    l = partdata_1.next[l - 1];
	    goto L10;
	}
    }
...
} /* genpack_csq_mina_hoverlap__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_nrdist__(n, x, i__, lstart)
integer *n;
doublereal *x;
integer *i__, *lstart;
{
...
/* Computing 2nd power */
    ...
    return ret_val;
} /* genpack_csq_mina_nrdist__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_gnrdist__(n, x, g, i__, lstart)
integer *n;
doublereal *x, *g;
integer *i__, *lstart;
{
...
} /* genpack_csq_mina_gnrdist__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_hnrdist__(n, x, hlin, hcol, hval, nnzh, 
	i__, lstart)
integer *n;
doublereal *x;
integer *hlin, *hcol;
...
} /* genpack_csq_mina_hnrdist__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_classify__(n, x)
integer *n;
doublereal *x;
{
    /* System generated locals */
    ...
    /* Local variables */
    extern /* Subroutine */ int genpack_csq_mina_region__();
...
/*     FILL-IN THE START STRUCTURE AGAIN */
    ...
    i__1 = packdata_1.nite;
    for (k = 1; k <= i__1; ++k) {
	genpack_csq_mina_region__(&partdata_1.nreg, &x[(k - 1) * 
		packdata_1.ndim + 1], &x[(k - 1) * packdata_1.ndim + 2], &i__,
		 &j);
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_region__(nreg, x, y, i__, j)
integer *nreg;
doublereal *x, *y;
integer *i__, *j;
{
...
/*     SCALAR ARGUMENTS */
/*     COMMON BLOCKS */
    *i__ = (integer) (*x / (packdata_1.iterad * 2.)) + 1;
/* Computing MIN */
    i__1 = max(1,*i__);
    *i__ = min(i__1,*nreg);
    *j = (integer) (*y / (packdata_1.iterad * 2.)) + 1;
/* Computing MIN */
    i__1 = max(1,*j);
    *j = min(i__1,*nreg);
} /* genpack_csq_mina_region__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
integer genpack_csq_mina_ceil__(x)
doublereal *x;
{
    /* System generated locals */
    integer ret_val;
...
/*     SCALAR ARGUMENTS */
    ...
    return ret_val;
} /* genpack_csq_mina_ceil__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal genpack_csq_mina_belong__(n, x, ind)
integer *n;
doublereal *x;
integer *ind;
{
...
/*     COMMON BLOCKS */
    ...
    /* Function Body */
    ret_val = x[*ind] + packdata_1.iterad - x[*n];
    return ret_val;
} /* genpack_csq_mina_belong__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_gbelong__(n, x, ind, gind, gval, nnzg)
integer *n;
doublereal *x;
integer *ind, *gind;
doublereal *gval;
...
/*     COMMON BLOCKS */
    ...
    *nnzg = 2;
    ...
    gind[*nnzg] = *n;
    gval[*nnzg] = -1.;
} /* genpack_csq_mina_gbelong__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int genpack_csq_mina_hbelong__(n, x, ind, hlin, hcol, hval, 
	nnzh)
integer *n;
doublereal *x;
