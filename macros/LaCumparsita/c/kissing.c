/* kissing.f -- translated by f2c (version 20000817).
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_inip__(n, x, l, u, m, lambda, rho, equatn, 
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalf__(n, x, f, flag__)
integer *n;
doublereal *x, *f;
integer *flag__;
{
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalg__(n, x, g, flag__)
integer *n;
doublereal *x, *g;
integer *flag__;
{
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalh__(n, x, hlin, hcol, hval, hnnz, flag__)
integer *n;
doublereal *x;
integer *hlin, *hcol;
doublereal *hval;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalc__(n, x, ind, c__, flag__)
integer *n;
doublereal *x;
integer *ind;
doublereal *c__;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evaljac__(n, x, ind, jcvar, jcval, jcnnz, flag__)
integer *n;
doublereal *x;
integer *ind, *jcvar;
doublereal *jcval;
...
/*     COMMON BLOCKS */
	...
	*jcnnz = probdata_1.ndim << 1;
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    ind2 = probdata_1.ndim * (i2 - 1) + i__;
	    jcvar[i__] = ind1;
	    jcval[i__] = (x[ind1] - x[ind2]) * -2.;
	    jcvar[probdata_1.ndim + i__] = ind2;
	    jcval[probdata_1.ndim + i__] = (x[ind1] - x[ind2]) * 2.;
	}
    }
} /* kissing_evaljac__ */
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalhc__(n, x, ind, hclin, hccol, hcval, hcnnz, 
	flag__)
integer *n;
doublereal *x;
...
/*     COMMON BLOCKS */
	...
	*hcnnz = probdata_1.ndim * 3;
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    hccol[i__] = ind1;
	    hcval[i__] = -2.;
	    hclin[probdata_1.ndim + i__] = ind2;
	    hccol[probdata_1.ndim + i__] = ind2;
	    hcval[probdata_1.ndim + i__] = -2.;
	    hclin[(probdata_1.ndim << 1) + i__] = ind2;
	    hccol[(probdata_1.ndim << 1) + i__] = ind1;
	    hcval[(probdata_1.ndim << 1) + i__] = 2.;
	}
    }
} /* kissing_evalhc__ */
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_evalhlp__(n, x, m, lambda, p, hp, goth, flag__)
integer *n;
doublereal *x;
integer *m;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int kissing_endp__(n, x, l, u, m, lambda, rho, equatn, 
	linear)
integer *n;
doublereal *x, *l, *u;
integer *m;
