/* mountain1.f -- translated by f2c (version 20000817).
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_inip__(n, x, l, u, m, lambda, rho, equatn, 
...
doublereal *dmax2_in__, *seed_in__;
{
    ...
    extern doublereal mountain1_fmoun__();
...
/*     Initial point */
/* Computing MAX */
    d__1 = mountain1_fmoun__(probdata_1.pi, &probdata_1.pi[1]), d__2 = 
	    mountain1_fmoun__(probdata_1.pf, &probdata_1.pf[1]);
    x[*n] = max(d__1,d__2);
    i__1 = probdata_1.np;
...
/* Computing MAX */
	d__1 = x[*n], d__2 = mountain1_fmoun__(&x[b + 1], &x[b + 2]);
	x[*n] = max(d__1,d__2);
    }
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalf__(n, x, f, flag__)
integer *n;
doublereal *x, *f;
integer *flag__;
{
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalg__(n, x, g, flag__)
integer *n;
doublereal *x, *g;
integer *flag__;
{
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalh__(n, x, hlin, hcol, hval, nnzh, flag__)
integer *n;
doublereal *x;
integer *hlin, *hcol;
doublereal *hval;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalc__(n, x, ind, c__, flag__)
integer *n;
doublereal *x;
integer *ind;
doublereal *c__;
...
/* Computing 2nd power */
	...
	*c__ = mountain1_fmoun__(&x[b + 1], &x[b + 2]) - x[*n];
    }
} /* mountain1_evalc__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evaljac__(n, x, ind, indjac, valjac, nnzjac, 
	flag__)
integer *n;
doublereal *x;
integer *ind, *indjac;
...
integer *nnzjac, *flag__;
{
    ...
    extern /* Subroutine */ int mountain1_gmoun__();
...
/*     COMMON BLOCKS */
	...
	*nnzjac = 3;
	b = *ind - probdata_1.np - 2 << 1;
	mountain1_gmoun__(&x[b + 1], &x[b + 2], &valjac[1], &valjac[2]);
	indjac[1] = b + 1;
	indjac[2] = b + 2;
	indjac[3] = *n;
	valjac[3] = -1.;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalhc__(n, x, ind, hclin, hccol, hcval, nnzhc,
	 flag__)
integer *n;
doublereal *x;
...
{
    static integer b, j, b1, b2;
    extern /* Subroutine */ int mountain1_hmoun__();
...
/*     COMMON BLOCKS */
	...
	*nnzhc = 3;
	b = *ind - probdata_1.np - 2 << 1;
	mountain1_hmoun__(&x[b + 1], &x[b + 2], &hcval[1], &hcval[2], &hcval[
		3]);
	hclin[1] = b + 1;
	hccol[1] = b + 1;
	hclin[2] = b + 2;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_evalhlp__(n, x, m, lambda, p, hp, goth, flag__)
integer *n;
doublereal *x;
integer *m;
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_endp__(n, x, l, u, m, lambda, rho, equatn, 
	linear)
integer *n;
doublereal *x, *l, *u;
integer *m;
...
logical *equatn, *linear;
{
    ...
    static integer i__;
    extern doublereal mountain1_fmoun__();
    extern /* Subroutine */ int mountain1_gmoun__(), mountain1_hmoun__();
...
/*     COMMON BLOCKS */
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
	b = i__ - 1 << 1;
	f = mountain1_fmoun__(&x[b + 1], &x[b + 2]);
	if (f > fmax) {
	    fmax = f;
	    imax = i__;
	}
    ...
    e_wsle();
    mountain1_gmoun__(&x[b + 1], &x[b + 2], g, &g[1]);
    s_wsle(&io___28);
    ...
    e_wsle();
    mountain1_hmoun__(&x[b + 1], &x[b + 2], h__, &h__[3], &h__[2]);
    s_wsle(&io___30);
...
/* Computing 2nd power */
	...
	do_lio(&c__9, &c__1, "Energy at previous point in the path: ", (
		ftnlen)38);
	d__1 = mountain1_fmoun__(&x[b + 1], &x[b + 2]);
	do_lio(&c__5, &c__1, (char *)&d__1, (ftnlen)sizeof(doublereal));
	e_wsle();
    }
...
/*     ****************************************************************** */
/*     ****************************************************************** */
doublereal mountain1_fmoun__(x, y)
doublereal *x, *y;
{
    /* System generated locals */
    doublereal ret_val;
...
/*     SCALAR ARGUMENTS */
    ret_val = sin(*x * *y) + sin(*x + *y);
    return ret_val;
} /* mountain1_fmoun__ */

/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_gmoun__(x, y, dfdx, dfdy)
...
/*     ****************************************************************** */
/*     ****************************************************************** */
/* Subroutine */ int mountain1_hmoun__(x, y, dfdxx, dfdyy, dfdxy)
...
/* Computing 2nd power */
    d__1 = *y;
    *dfdxx = -(d__1 * d__1) * sin(*x * *y) - sin(*x + *y);
/* Computing 2nd power */
    d__1 = *x;
    *dfdyy = -(d__1 * d__1) * sin(*x * *y) - sin(*x + *y);
