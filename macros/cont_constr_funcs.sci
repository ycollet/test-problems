...
function Res = get_min_G1()
Res = zeros(13,1);
endfunction

function Res = get_max_G1()
Res = ones(13,1);
Res($-3:$-1) = 100;
endfunction
...
function Res = get_min_G2(n)
if ~isdef('n','local') then n = 20; end
Res = zeros(n,1);
endfunction

function Res = get_max_G2(n)
if ~isdef('n','local') then n = 20; end
Res = 10*ones(n,1);
endfunction
...
function Res = get_min_G3(n)
if ~isdef('n','local') then n = 4; end
Res = zeros(n,1);
endfunction

function Res = get_max_G3(n)
if ~isdef('n','local') then n = 4; end
Res = ones(n,1);
endfunction
...
function Res = get_min_G4()
Res = [78 33 27 27 27]';
endfunction

function Res = get_max_G4()
Res = [102,45,45,45,45]';
endfunction
...
function Res = get_min_G5()
Res = [0 0 -0.55 -0.55]';
endfunction

function Res = get_max_G5()
...
function Res = get_min_G6()
Res = [13 0]';
endfunction

function Res = get_max_G6()
Res = [100 100]';
endfunction
...
function Res = get_min_G7()
Res = -10*ones(10,1);
endfunction

function Res = get_max_G7()
Res = 10*ones(10,1);
endfunction
...
function Res = get_min_G8()
Res = zeros(2,1);
endfunction

function Res = get_max_G8()
Res = 10*ones(2,1);
endfunction
...
function Res = get_min_G9()
Res = -10*ones(7,1);
endfunction

function Res = get_max_G9()
Res = 10*ones(7,1);
endfunction
...
function Res = get_min_G10()
Res = 10*[10 100 100 1 1 1 1 1]';
endfunction

function Res = get_max_G10()
...
function Res = get_min_G11()
Res = [-1 -1]';
endfunction

function Res = get_max_G11()
Res = [1 1]';
endfunction
...
function Res = get_min_G12()
Res = [0 0 0]';
endfunction

function Res = get_max_G12()
Res = [10 10 10]';
endfunction
...
function Res = get_min_G13()
Res = - [2.3 2.3 3.2 3.2 3.2]';
endfunction

function Res = get_max_G13()
Res = [2.3 2.3 3.2 3.2 3.2]';
endfunction
...
function Res = get_min_weldedbeam()
Res = [0.125 0.1 0.1 0.1]';
endfunction

function Res = get_max_weldedbeam()
Res = [10 10 10 10]';
endfunction
...
function y = weldedbeam_ineq_constr(x)
// Matlab Code by A. Hedar (Nov. 23, 2005).
// Parameters
...
function y = weldedbeam_eq_constr(x)
y = 0;
endfunction
...
function Res = get_min_pressurevessel()
Res = -1e6 * ones(4,1);
endfunction

function Res = get_max_pressurevessel()
Res = 1e6 * ones(4,1);
endfunction
...
function y = pressurevessel_ineq_constr(x)
// Matlab Code by A. Hedar (Nov. 23, 2005).
// Constraints
y(1) = -x(1)+0.0193*x(3);
y(2) = -x(2)+0.00954*x(3);
...
function y = pressurevessel_eq_constr(x)
y = 0;
endfunction
...
function Res = get_min_tensioncompr()
Res = [0 0 0]';
endfunction

function Res = get_max_tensioncompr()
Res = [100 100 100]';
endfunction
...
function y = tensioncompr_ineq_constr(x)
// Matlab Code by A. Hedar (Nov. 23, 2005).
// Constraints
...
function y = tensioncompr_eq_constr(x)
y = 0;
endfunction
...
function Res = get_min_elec_on_sph(n)
if ~isdef('n','local') then n = 10; end
Res = -2 * ones(n,1);
endfunction
function Res = get_max_elec_on_sph(n)
if ~isdef('n','local') then n = 10; end
Res = 2 * ones(n,1);
endfunction
...
function [diff_bound] = elec_on_sph_ineq_constr(x)
diff_bound = 0;
endfunction

function [diff_bound] = elec_on_sph_eq_constr(x)
...
function Res = get_min_larg_sm_poly(n)
if ~isdef('n','local') then n = 10; end
Res = -10 * ones(2*n,1);
endfunction

function Res = get_max_larg_sm_poly(n)
if ~isdef('n','local') then n = 10; end
Res = 10 * ones(2*n,1);
endfunction
...
function [diff_bound] = larg_sm_poly_ineq_constr(r, theta)
nb_var = size(r,1);
...
function [diff_bound] = larg_sm_poly_eq_constr(r, theta)
diff_bound = 0;
endfunction
...
function Res = get_min_vv_open(n)
if ~isdef('n','local') then n = 10; end
Res = -10 * ones(n,1);
endfunction

function Res = get_max_vv_open(n)
if ~isdef('n','local') then n = 10; end
Res = 10 * ones(n,1);
endfunction
...
function [diff_bound] = vv_open_ineq_constr(r)
...
function Res = get_min_himmelblau_1()
Res = -10 * ones(2,1);
endfunction

function Res = get_max_himmelblau_1()
Res = 10 * ones(2,1);
endfunction
...
function diff_bound = himmelblau_1_ineq_constr(x)
diff_bound(1) = x(1) - 2*x(2) + 1;
diff_bound(2) = x(1)^2/4 + x(2)^2 - 1;
endfunction

function diff_bound = himmelblau_1_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_3()
Res = -1e6 * ones(2,1);
endfunction

function Res = get_max_himmelblau_3()
Res = 1e6 * ones(2,1);
endfunction
...
function diff_bound = himmelblau_3_ineq_constr(x)
// 0 <= x1 <= 75
// 0 <= x1 <= 65
// x1*x2 - 700  >= 0
// x2 - 5*(x1/25)^2 >= 0
...
function diff_bound = himmelblau_3_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_4()
Res = -1e6 * ones(10,1);
endfunction

function Res = get_max_himmelblau_4()
Res = 1e6 * ones(10,1);
endfunction
...
function diff_bound = himmelblau_4_ineq_constr(x)
...
function diff_bound = himmelblau_4_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_4a()
Res = -1e6 * ones(10,1);
endfunction

function Res = get_max_himmelblau_4a()
Res = 1e6 * ones(10,1);
endfunction
...
function diff_bound = himmelblau_4a_ineq_constr(x)
...
function diff_bound = himmelblau_4a_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_5()
Res = -1e6 * ones(3,1);
endfunction

function Res = get_max_himmelblau_5()
Res = 1e6* ones(3,1);
endfunction
...
function diff_bound = himmelblau_5_ineq_constr(x)
...
function diff_bound = himmelblau_5_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_8()
Res = -1e6 * ones(4,1);
endfunction

function Res = get_max_himmelblau_8()
Res = 1e6 * ones(4,1);
endfunction
...
function diff_bound = himmelblau_8_ineq_constr(x)
// -10 <= xi <= 10
diff_bound(1) = - x(1) - 10;
diff_bound(2) = - x(2) - 10;
diff_bound(3) = - x(3) - 10;
...
function diff_bound = himmelblau_8_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_9()
Res = -1e6 * ones(4,1);
endfunction

function Res = get_max_himmelblau_9()
Res = 1e6 * ones(4,1);
endfunction
...
function diff_bound = himmelblau_9_ineq_constr(x)
// x3 + (1-x3)*x4 >= 0
// x4 > 0.1
// x3 <= 1
...
function diff_bound = himmelblau_9_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_10()
Res = -1e6 * ones(5,1);
endfunction

function Res = get_max_himmelblau_10()
Res = 1e6 * ones(5,1);
endfunction
...
function diff_bound = himmelblau_10_ineq_constr()
A = [-16  2  0  1  0   ; ...
      0  -2  0  .4 2   ; ...
     -3.5 0  2  0  0   ; ...
      0  -2  0 -4 -1   ; ...
...
function diff_bound = himmelblau_10_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_11()
Res = -1e6 * ones(5,1);
endfunction

function Res = get_max_himmelblau_11()
Res = 1e6 * ones(5,1);
endfunction
...
function diff_bound = himmelblau_11_ineq_constr(x)
...
function diff_bound = himmelblau_11_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_12()
Res = -1e6 * ones(5,1);
endfunction

function Res = get_max_himmelblau_12()
Res = 1e6 * ones(5,1);
endfunction
...
function diff_bound = himmelblau_12_ineq_constr(x)
y1 = x(2) + x(3) + 41.6;
c1 = 0.024*x(4) - 4.62;
y2 = 12.5 / c1 + 12;
c2 = 0.0003535*x(1)^2 + 0.5311*x(1) + 0.08705*y2*x(1);
...
function diff_bound = himmelblau_12_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_13()
Res = -1e6 * ones(5,1);
endfunction

function Res = get_max_himmelblau_13()
Res = 1e6 * ones(5,1);
endfunction
...
function diff_bound = himmelblau_13_ineq_constr(x)
K = [-145421.402 2931.1506 -40.427932 5106.192 15711.36 -161622.577 4176.15328 2.8260078 9200.476 13160.295 -21686.9194 123.56928 ...
     -21.1188894 706.934 2898.573 28298.388 60.81096 31.242116 329.574 -2882.082 74095.3845 -306.262544 16.243649 -3094.252 -5566.2628 ...
     -26.237 99 -0.42 1300 2100 925548.252 -61968.8432 23.3088196 -27097.648 -50843.766];
...
function diff_bound = himmelblau_13_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_14()
Res = -1e6 * ones(6,1);
endfunction

function Res = get_max_himmelblau_14()
Res = 1e6 * ones(6,1);
endfunction
...
function diff_bound = himmelblau_14_ineq_constr(x)
...
function diff_bound = himmelblau_14_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_15()
Res = -1e6 * ones(6,1);
endfunction

function Res = get_max_himmelblau_15()
Res = 1e6 * ones(6,1);
endfunction
...
function diff_bound = himmelblau_15_ineq_constr(x)
...
function diff_bound = himmelblau_15_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_16()
Res = -1e6 * ones(9,1);
endfunction

function Res = get_max_himmelblau_16()
Res = 1e6 * ones(9,1);
endfunction
...
function diff_bound = himmelblau_16_ineq_constr(x)
...
function diff_bound = himmelblau_16_eq_constr(x)
diff_bound = 0;
endfunction
...
function Res = get_min_himmelblau_24()
Res = -10 * ones(2,1);
endfunction

function Res = get_max_himmelblau_24()
Res = 10 * ones(2,1);
endfunction
...
function diff_bound = himmelblau_24_ineq_constr(x)
diff_bound(1) = x(1)^2 - x(2);
diff_bound(2) = x(1) + x(2) - 2;
endfunction

function diff_bound = himmelblau_24_eq_constr(x)
diff_bound = 0;
endfunction
