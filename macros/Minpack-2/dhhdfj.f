...
c     Initialization.
      ...
      if (prob(1:5) .eq. 'DHHD1') then
         ...
         sume = 0.167d0
         sumf = -0.399d0
      else if (prob(1:5) .eq. 'DHHD2') then
         summx = -0.69d0
         summy = -0.044d0
         suma = -1.57d0
         sumb = -1.31d0
         ...
         sume = -12.6d0
         sumf = 9.48d0
      else if (prob(1:5) .eq. 'DHHD3') then
         summx = -0.816d0
         summy = -0.017d0
         suma = -1.826d0
         sumb = -0.754d0
         ...
         sume = -14.023d0
         sumf = 15.467d0
      else if (prob(1:5) .eq. 'DHHD4') then
         summx = -0.809d0
         summy = -0.021d0
         suma = -2.04d0
         sumb = -0.614d0
         ...
         sume = -26.328d0
         sumf = 18.639d0
      else if (prob(1:5) .eq. 'DHHD5') then
         summx = -0.807d0
         summy = -0.021d0
         suma = -2.379d0
         sumb = -0.364d0
...
c     task = 'XU'.
      ...
      if (task(1:2) .eq. 'XL' .or. task(1:2) .eq. 'XU') then
         if (task(1:2) .eq. 'XL') temp = -twenty
         if (task(1:2) .eq. 'XU') temp = twenty
         do 10 i = 1, n
            x(i) = temp
   10    continue
         if (task(1:2) .eq. 'XU') x(1) = zero
