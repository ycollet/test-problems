      ...
      integer nx, ny
      real x(nx*ny), s(nx*ny), y(nx*ny), bottom(nx+2), top(nx+2),
...
c     **********
      ...
      integer i, j, k
      real area, dvdx, dvdxhx, dvdy, dvdyhy, dzdx, dzdxhx, dzdy, dzdyhy,
     +     fl, fl3, fu, fu3, hx, hy, tl, tu, v, vb, vl, vr, vt, z, zb,
     +     zl, zr, zt
