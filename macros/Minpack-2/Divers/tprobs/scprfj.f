...
c
c     **********
      real eight, forty, four, one, p, p005, p05, p5, rr, ten, three,
     +     two, zero
      parameter (zero=0.0,p005=5.0E-3,p05=5.0E-2,p5=0.5,one=1.0,two=2.0,
     +          three=3.0,four=4.0,eight=8.0,ten=1.0E1,forty=4.0E1)
