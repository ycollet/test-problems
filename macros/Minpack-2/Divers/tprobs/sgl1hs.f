...
c     f''(x) is the Hessian matrix for the Ginzburg-Landau
c     (1-dimensional) problem.
c
...
c
c     **********
      real four, one, six, sxteen, ten, three, twelve, two, zero
      parameter (zero=0.0,one=1.0,two=2.0,three=3.0,four=4.0,six=6.0,
     +          ten=10.0,twelve=12.0,sxteen=16.0)

      integer i, n1, n2
      real alphan, alphas, betan, betas, c, dn, ds, ec, em, fac, gamma,
     +     h1, h2, hbar, hcn, hcs, penn, pens, pi, tcn, tcs
...
c     Evaluate f''(x)*s over the intervals (-d, -ds), (-ds, ds),
c     and (ds, d).
