...
c
c     **********
      real four, one, three, two, zero
      parameter (zero=0.0,one=1.0,two=2.0,three=3.0,four=4.0)

      logical feval, jeval
      integer i, j, k, n
      real dpdx, dpdy, hx, hx2, hx4, hx2hy2, hy, hy2, hy4, p, pb, pbb,
     +     pbl, pblap, pbr, pl, plap, pll, pllap, pr, prlap, prr, pt,
     +     ptl, ptlap, ptr, ptt, xx, yy
