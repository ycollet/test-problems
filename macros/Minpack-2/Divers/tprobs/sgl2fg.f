...
c
c       subroutine sgl2fg(nx,ny,x,f,fgrad,task,w,vornum)
c
c     where
c
...
c     Pack work array.
   ...
   20 continue
      ...
      call sgl2fc(nx,ny,w(1),w(itemp+1),w(2*itemp+1),w(3*itemp+1),f,
...
c     Unpack work array
   ...
   40 continue
      ...
      subroutine sgl2fc(nx,ny,x,y,vpotx,vpoty,f,gradx,grady,gradax,
     +                  graday,task,vornum)
      character*(*) task
      integer nx, ny, vornum
      real x(nx+1,ny+1), y(nx+1,ny+1), vpotx(nx+1,ny+1),
...
c     The subroutine statement is
c
c       subroutine sgl2fc(nx,ny,x,y,vpotx,vpoty,f,
...
c
c     **********
      real five, four, one, three, two, zero
      parameter (zero=0.0,one=1.0,two=2.0,three=3.0,four=4.0,five=5.0)

      integer i, j
      real arg, bave, cfac, delsq, f, fcond, ffield, fkin, fkinx1,
     +     fkinx2, fkiny1, fkiny2, hx, hy, pi, sfac, sqn, sqrtv, tkappa,
     +     x1, x2, xpt, xy, ypt
