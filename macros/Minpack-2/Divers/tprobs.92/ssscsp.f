      subroutine ssscsp(nx,ny,nnz,indrow,indcol)
      integer nx,ny,nnz
...
c     matrix for the Steady State Combustion problem.  Given the
c     number of grid points nx and ny, ssscsp provides column and row
c     indices for the nonzeros in the lower triangle of the Hessian.
c     The number of nonzeros, nnz, is also provided.
c
c     The subroutine statement is:
c
c       subroutine ssscsp(nx,ny,nnz,indrow,indcol)
c
c     where
c
