...
c     **********
     ...
     +       dpdy,dpdx,pblap,pllap,prlap,ptlap,hy,hx,hy2,hx2
     ...
     +                               (two/hy2/hx2 + r*(dpdy/hy2/(two*hx)
     +                                   - dpdx/hx2/(two*hy)))*s(k-nx-1)
     ...
     +                                              three/hy2/hy2))*s(k)
            if (i .eq. 1) y(k) = y(k) + 
     +                        (one/hy2/hy2 - r*(dpdx/hy2/(two*hy)))*s(k)
            if (j .eq. 1) y(k) = y(k) + 
     +                        (one/hx2/hx2 + r*(dpdy/hx2/(two*hx)))*s(k)
            if (j .eq. nx) y(k) = y(k) +
     +                        (one/hx2/hx2 - r*(dpdy/hx2/(two*hx)))*s(k)
            if (i .eq. ny) y(k) = y(k) +
     +                        (one/hy2/hy2 + r*(dpdx/hy2/(two*hy)))*s(k)
