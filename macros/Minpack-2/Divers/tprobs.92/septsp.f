      subroutine septsp(nx,ny,nnz,indrow,indcol)
      integer nx,ny,nnz
...
c     matrix for the Elastic Plastic Torsion problem. Given the number
c     of grid points nx and ny, septsp provides column and row indices
c     for the nonzeros in the lower triangle of the Hessian. The number
c     of nonzeros, nnz, is also provided.
c
c     The subroutine statement is:
c
c       subroutine septsp(nx,ny,nnz,indrow,indcol)
c
c     where
c
