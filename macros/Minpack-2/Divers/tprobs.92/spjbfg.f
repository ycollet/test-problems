      subroutine spjbfg(nx,ny,x,f,fgrad,task,ecc,b)
      character*(*) task
      integer nx,ny
      real f,ecc,b
...
c
c       subroutine spjbfg(nx,ny,x,f,fgrad,task,ecc,b)
c
c     where
c
...
c
c     **********
      real zero,p5,one,two,four,six
      parameter (zero=0.0,p5=0.5,one=1.0,two=2.0,four=4.0,six=6.0)

      integer i,j,k
      real flin,fquad,trule,v,vb,vl,vr,vt,xi,pi,hx,hy,hxhy,temp,dvdx,
     +     dvdy,ehxhy
...
c
c     **********
      real one,two,three,four,six
      parameter (one=1.0,two=2.0,three=3.0,four=4.0,six=6.0)

      integer i,j,k
      real xi,pl,pc,pr,rulel,ruler,ruleu,ruled,hx,hy,hxhy,pi
