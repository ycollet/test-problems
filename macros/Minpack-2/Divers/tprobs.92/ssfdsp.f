      subroutine ssfdsp(n,nint,nnz,indrow,indcol)
      integer n,nint,nnz
...
c     matrix for the Swirling Flow between Disks problem. Given the
c     number of subintervals in the k-stage collocation, ssfdsp
c     provides column and row indices for the nonzeros in the
c     Jacobian. The number of nonzeros, nnz, is also provided.
c
c     The subroutine statement is:
c
c       subroutine ssfdsp(n,nint,nnz,indrow,indcol)
c
c     where
c
