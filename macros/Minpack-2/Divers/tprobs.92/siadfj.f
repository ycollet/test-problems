...
c     **********
      ...
      real zero,two,three,six,hundrd
      parameter (zero=0.0,two=2.0,three=3.0,six=6.0,hundrd=1.0E2)

      integer i,j,k,iobs,ne
      real h,ho2,ho6,t
      real y(neqext),work(neqext),k1(neqext),k2(neqext),k3(neqext),
     +k4(neqext),time(nobs),obs(neq,nobs)

      data time /1230.0,3060.0,4920.0,7800.0,10680.0,15030.0,22620.0,
     +           36420.0/
      data obs /88.35,7.3,2.3,0.4,1.75,76.40,15.6,4.5,0.7,2.80,65.10,
     +          23.1,5.3,1.1,5.80,50.40,32.9,6.0,1.5,9.30,37.50,42.7,
     +          6.0,1.9,12.00,25.90,49.1,5.9,2.2,17.00,14.00,57.4,5.1,
     +          2.6,21.00,4.50,63.1,3.8,2.9,25.7/
