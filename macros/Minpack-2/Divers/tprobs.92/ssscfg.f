      subroutine ssscfg(nx,ny,x,f,fgrad,task,lambda)
      character*(*) task
      integer nx,ny
      real f,lambda
...
c
c       subroutine ssscfg(nx,ny,x,f,fgrad,task,lambda)
c
c     where
c
...
c     **********
      ...
      integer i,j,k
      real fexp,fquad,dvdx,dvdy,hx,hy,v,vb,vl,vr,vt,expv,expvr,expvt,
     +     expvb,expvl,area,temp,temp1
