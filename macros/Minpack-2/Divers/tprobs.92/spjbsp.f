      subroutine spjbsp(nx,ny,nnz,indrow,indcol)
      integer nx,ny,nnz
...
c     matrix for the Pressure Distribution in a Journal Bearing problem.
c     Given the number of grid points nx and ny, spjbsp provides column
c     and row indices for the nonzeros in the lower triangle of the
c     Hessian. The number of nonzeros, nnz, is also provided.
c
c     The subroutine statement is:
c
c       subroutine spjbsp(nx,ny,nnz,indrow,indcol)
c
c     where
c
...
c         On exit nnz is set to the number of nonzero in the
