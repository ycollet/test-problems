...
c     of the Analysis of an Enzyme Reaction problem formulated by
c     J. Kowalik and J. Morrison.  This is a data fitting problem that
c     arises in the analysis of the kinetic data for an enzyme reaction.
c
...
c            For the enzyme reaction problem m = 11.
c         On exit m is unchanged.
c
c       n is an integer variable.
c         On entry n is the number of variables.
c            For the enzyme reaction problem n = 4.
...
c     *********
      ...
      real temp1,temp2
      real v(11),y(11)
      data v /4.0,2.0,1.0,5.0E-1,2.5E-1,1.67E-1,1.25E-1,1.0E-1,8.33E-2,
     +       7.14E-2,6.25E-2/
      data y /1.957E-1,1.947E-1,1.735E-1,1.6E-1,8.44E-2,6.27E-2,4.56E-2,
     +       3.42E-2,3.23E-2,2.35E-2,2.46E-2/

c     Check input arguments for errors.

      if (m.ne.11) task = 'ERROR: M MUST .EQ. 11'
      if (n.ne.4) task = 'ERROR: N MUST .EQ. 4'
