...
c     *******
      integer maxit
      parameter(maxit=5)
      double precision b,t,l,r
      parameter(b=-.50d0,t=.50d0,l=-.50d0,r=.50d0)
      double precision tol,one,two,three
      parameter(tol=1.0d-10,one=1.0d0,two=2.0d0,three=3.0d0)

      integer i,j,k,limit
      double precision fnorm,xt,yt,det,hx,hy
      double precision nf(2),u(2),njac(2,2)
