...
c     matrix for the Two-Dimensional Ginzburg-Landau Superconductivity 
c     problem. Given the number of grid points nx and ny, dgl2sp 
c     provides column and row indices for the nonzeros in the lower 
c     triangle of the Hessian. The number of nonzeros, nnz, is also 
c     provided.
c
c     The subroutine statement is:
c
c       subroutine dgl2sp(nx,ny,nnz,indrow,indcol)
c
c     where
c
...
c     Order each of the four surfaces dof = 1,2,3,4 sequentially for
