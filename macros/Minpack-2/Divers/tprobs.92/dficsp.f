      subroutine dficsp(n,nint,nnz,indrow,indcol)
      integer n,nint,nnz
...
c     matrix for the Flow In a Channel problem.  Given the number 
c     of subintervals in the k-stage collocation, dficsp provides 
c     column and row indices for the nonzeros in the Jacobian. The 
c     number of nonzeros, nnz, is also provided.
c
c     The subroutine statement is:
c
c      subroutine dficsp(n,nint,nnz,indrow,indcol)
c
c     where
c
